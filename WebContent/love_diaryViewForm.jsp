	...
	<div class="joinForm_div">
		...
		<table class="coment_t2">
			<tbody>
				...
				<tr>
					<td colspan=3 class="coment_md"><a class="m_a"  onclick="location.href='love_commUpdateForm.jsp?ID=<%=list.get(i).getID() %>'">수정</a>
					<a class="m_a"  onclick="return confirm('정말로 삭제하시겠습니까?')" href='love_commDelete.jsp?ID=<%=list.get(i).getID() %>'>삭제</a>
					</td>
				</tr>
				<%
					}
